...
HXLINE( 209)
HXLINE( 210)		HX_VARI( int,n) = 0;
HXLINE( 211)		if (::hx::IsNull( pred )) {
HXLINE( 212)			HX_VARI(  ::Dynamic,_) = it->__Field(HX_("iterator",ee,49,9a,93),::hx::paccDynamic)();
HXDLIN( 212)			while(( (bool)(_->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 212)				HX_VARI_NAME(  ::Dynamic,_1,"_") = _->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 213)				n = (n + 1);
            			}
            		}
            		else {
HXLINE( 215)			HX_VARI(  ::Dynamic,x) = it->__Field(HX_("iterator",ee,49,9a,93),::hx::paccDynamic)();
HXDLIN( 215)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 215)				HX_VARI_NAME(  ::Dynamic,x1,"x") = x->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
